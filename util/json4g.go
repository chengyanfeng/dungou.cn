...
func NewJsonNodeByString(nodename, jsonstr string) (json *JsonNode) {
	defer func() {
...
func NewJsonNode(nodename string, nodevalue interface{}) (json *JsonNode) {
	defer func() {
		if er := recover(); er != nil {
